            ...
            <div>
                <div>
                    <div x-data="{ openTab: 1 }" class="pt-3">
                        ...
                        <div x-data="{ showModal: false }" class="mb-3 flex justify-end" id="ajaxModal">
                
                            <button x-on:click="showModal = true" href="javascript:void(0)" id="addNewPatron"
                                class="bg-green-800 hover:bg-green-800 p-3 rounded-md text-white font-medium">Add Patron
                            </button>
                        ...
                        <div class="w-full">
                            ...
                            <div x-show="openTab === 1"
                                ...
                                <table class="w-full bg-white border border-gray-200 rounded-md shadow-md mt-2" id="student-table1">
                                    <thead class="bg-green-800 text-white text-left sticky top-0 z-10">
                                        <tr class="bg-green-800 text-white text-center">
                                            <th class="py-3 px-8 border-b border-gray-200 w-[16rem] rounded-tl" name="school_id">
                                                STUDENT NO.
                                            </th>
                            ...
                            <div x-show="openTab === 2"
                                ...
                                <table class="w-full bg-white border border-gray-200 rounded-md shadow-md mt-2" id="faculty-table2">
                                    <thead class="bg-green-800 text-white text-left sticky top-0 z-10">
                                        <tr class="bg-green-800 text-white text-center">
                            ...
                            <div x-show="openTab === 3"
                                ...
                                <table class="w-full bg-white border border-gray-200 rounded-md shadow-md mt-2" id="staff-table3">
                                    <thead class="bg-green-800 text-white text-left sticky top-0 z-10">
                                        <tr class="bg-green-800 text-white text-center">
                                            <th class="py-3 px-8 border-b border-gray-200 w-[16rem] rounded-tl">
                                                STAFF ID
                            ...
                            <div x-show="openTab === 4"
                                ...
                                <table class="w-full bg-white border border-gray-200 rounded-md shadow-md mt-2" id="guest-table4">
                                    <thead class="bg-green-800 text-white text-left sticky top-0 z-10">
                                        <tr class="bg-green-800 text-white text-center">
                                            <th class="py-3 px-8 border-b border-gray-200 w-[16rem] rounded-tl">
                                                GUEST ID
